          ...
          <footer className="mobile-nav mobile">
            ...
            >
              ...
              >
                ...
                <g clipPath="url(#clip0_18_977)">
                  <g clipPath="url(#clip1_18_977)">
                    <path
            ...
            >
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clipPath="url(#clip0_18_964)">
                  <g clipPath="url(#clip1_18_964)">
                    <path
            ...
            >
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clipPath="url(#clip0_18_972)">
                  <g clipPath="url(#clip1_18_972)">
                    <path
          ...
          <footer className="pc pc-footer-container">
            ...
            <div className="pc-footer">
              <div className="footer-info">
                ...
                <span>
                  Block A2 Suite 12FF Aregbeshola shopping mall
                  <br />
